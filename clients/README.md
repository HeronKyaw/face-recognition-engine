...
A **Flutter** mobile app (Android/iOS). Mirrors the web client functionality — user selection, face enrollment/verification via camera or gallery, and verification logs. Uses Material Design 3 with indigo theming.

## desktop/

Placeholder for a future desktop client. No implementation yet.
